    ...
    while (True):
        ...
        if choice == "2":           ## Start Order process
            ...
            while (True):
                ...
                Adults_Number = input("Select Number of Adults:  "); list.append(Adults_Number)
                Children_Number = input("Select number of Children:  "); list.append(Children_Number)
                Choice_Days = int(input("Select Number Days To Stay in a Week, (Sun-Thu):  "))
                print("Please Select the Days You want to Stay,")
                Choice_Days_Sunday = input("Sunday: Y/N  "); list_Days_Stay.append("Sunday")
                Choice_Days_Monday = input("Monday: Y/N  "); list_Days_Stay.append("Monday")
                Choice_Days_Tuesday = input("Tuesday: Y/N  "); list_Days_Stay.append("Tuesday")
                Choice_Days_Wednesday = input("Wednesday: Y/N  "); list_Days_Stay.append("Wednesday")
                Choice_Days_Thursday = input("Thursday: Y/N  "); list_Days_Stay.append("Thursday")
                ...
                if Order_Approval == "y":
                    ...
                    if Choice_Hotel == "1":
                        ...
                        if list == ['1', '']: print(Room1_Satai_Definition); list_Room_Price = Room1_Satai_Price; break
                        if list == ['1', '0']: print(Room1_Satai_Definition); list_Room_Price = Room1_Satai_Price; break
                        if list == ['1', '1']: print(Room1_Satai_Definition); list_Room_Price = Room1_Satai_Price; break
                        if list == ['1', '2']: print(Room4_Satai_Definition); list_Room_Price = Room4_Satai_Price; break
                        if list == ['2', '']: print(Room1_Satai_Definition); list_Room_Price = Room1_Satai_Price; break
                        if list == ['2', '0']: print(Room1_Satai_Definition); list_Room_Price = Room1_Satai_Price; break
                        if list == ['2', '1']: print(Room2_Satai_Definition); list_Room_Price = Room2_Satai_Price; break
                        if list == ['2', '2']: print(Room4_Satai_Definition); list_Room_Price = Room4_Satai_Price; break
                        if list == ['2', '3']: print(Room14_Satai_Definition); list_Room_Price = Room14_Satai_Price; break
                        if list == ['2', '4']:
                    ...
                    if Choice_Hotel == "2":
                        ...
                        if list == ['1', '']:
                            print(Room1_Iris_Definition); list_Room_Price = Room1_Iris_Price; break
                        if list == ['1', '0']:
                            print(Room1_Iris_Definition); list_Room_Price = Room1_Iris_Price; break
                        if list == ['1', '1']:
                            print(Room1_Iris_Definition); list_Room_Price = Room1_Iris_Price; break
                        if list == ['1', '2']:
                            print(Room4_Iris_Definition); list_Room_Price = Room4_Iris_Price; break
                        if list == ['2', '']:
